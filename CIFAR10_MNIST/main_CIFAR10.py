"""
This code learns to sub-sample CIFAR10 images in the Fourier domain and reconstructs or classifies them.
...
==============================================================================
    ...
    Source Name   : main_CIFAR10.py
                    This main file calls the model to sub-sample CIFAR10 images in the Fourier domain and reconstruct/classify them.
